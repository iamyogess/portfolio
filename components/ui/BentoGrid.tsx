...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1 relative rounded-3xl overflow-hidden group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none border-white/[0.1] justify-between flex flex-col space-y-4 ",
        className
      )}
      style={{
